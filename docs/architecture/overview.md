...
purpose: One-page architectural summary — three layers, three actors, where state lives. Pointer doc to the full design spec.
...
For full detail (account structures, validator logic, endpoint shapes, schema, failure modes), see the [design spec](../specs/2026-04-28-agent-wallet-design.md).
...
| Treasury USDC float (Dodo bridge) | Off-chain | Single hot wallet, capped at minimum viable for MVP |
...
- [Design spec](../specs/2026-04-28-agent-wallet-design.md) — full architecture, account structures, endpoint shapes, schema, failure modes, testing strategy
- [Project context](../../CONTEXT.md) — strategic framing, locked architecture decisions, why this niche over Locus-clone
- [TODO.md](../../TODO.md) — implementation task tracking
- [Team collaboration runbook](../runbooks/team-collaboration.md) — how the team works on this codebase
